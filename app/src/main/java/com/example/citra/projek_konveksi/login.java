...
public class login extends AppCompatActivity {
    ...
    String id, username;
    public static final String my_shared_preference ="my_shared_preferences";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TxtRegister = findViewById(R.id.tvRegisterLink);

        //cek session login jika True maka langsung buka activity_main
